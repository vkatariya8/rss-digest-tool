...
def main():
    ...
    if not all([gemini_api_key, smtp_email, smtp_password, recipient_email, feed_urls]):
    ...
    logger.info("Evaluating articles with Gemini...")
    relevant = evaluate_articles(articles, gemini_api_key)
